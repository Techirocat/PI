(* Bom Blog:  https://observablehq.com/@galopin/the-chudnovsky-algorithm-for-calculating-pi *)

(* Implementação retirada do repo: https://github.com/pie-314/PiEngine *)

(* O algoritmo de Chudnovsky foi utilizado para calcular o recorde mundial de π com 100 triliões de dígitos. *)
open Z
...
let () =
  let casas_decimais = 100 in
  let pi_str = compute_pi casas_decimais in
  PI.check (String.sub pi_str 2 casas_decimais);
  Printf.printf "\n%s\n\n" pi_str; 
